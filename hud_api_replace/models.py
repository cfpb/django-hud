...
class CounselingAgency(models.Model):
    ...
    email = models.CharField(max_length=100)                # ex "johndoe@test.org",
    fax = models.CharField(max_length=20)                   # ex "302-224-4059",
    ...
    weburl = models.CharField(max_length=255)               # ex "http://www.wycade.org",
